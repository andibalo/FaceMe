...
class App extends React.Component {
  ...
  render() {
    return (
      <div className="App">
        ...
        <Navigation />
        <Logo/>
        <ImageLinkForm changeOnInput={this.changeOnInput} onButtonSubmit = {this.onSubmit}/>
  ...
  faceBoxArea = (data) => {
    const picCoordinates = data.outputs[0].data.regions[0].region_info.bounding_box   
